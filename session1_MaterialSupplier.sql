...
CREATE TABLE `MaterialSupplier` (
  ...
  CONSTRAINT `FK_MaterialSupplier_Material` FOREIGN KEY (`MaterialID`) REFERENCES `Material` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_MaterialSupplier_Supplier` FOREIGN KEY (`SupplierID`) REFERENCES `Supplier` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
